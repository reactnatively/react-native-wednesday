APIKey: zy7QELkGLaIdbdzeXveQRTfqD
API Secret Key: 352Xj5wW56RTgMoCUD8CfMWnTvV5mfzhU1GsZDZ3QIUE901pUT
Callback url :https://notearise-v1808.firebaseapp.com/__/auth/handler
...
A. Definitions
    ...
    Licensed Material ‒ A collective term for the Twitter API and Twitter Content.
    Periscope Broadcast - A live or on-demand video stream that is publicly displayed on Twitter Services and is generated by a user via Twitter’s Periscope Producer feature (as set forth at https://help.periscope.tv/customer/en/portal/articles/2600293).
    Services ‒ Your websites, applications and other offerings that display Twitter Content or otherwise use the Licensed Material as approved by Twitter through any onboarding process.
    ...
    Direct Message - A text and/or multimedia-based posting that is privately sent on Twitter Services by one end user to one or more specific end user(s).
...
D. Incorporated Terms. Your use of the Licensed Material is further subject to and governed by the following terms and conditions:
    ...
    the Twitter Developer Policy located at https://developer.twitter.com/en/developer-terms/policy (“Developer Policy”);
    as it relates to your display of any of the Twitter Content, the Display Requirements located at https://developer.twitter.com/en/developer-terms/display-requirements (“Display Requirements”);
...
IV. Ownership and Feedback
    ...
    Feedback. You may provide Twitter with comments concerning the Licensed Material, Services or your evaluation and use thereof (collectively, "Feedback"). You hereby grant Twitter all rights, title and ownership of such Feedback (including all intellectual property rights therein), and Twitter may use the Feedback for any and all commercial and non-commercial purposes with no obligation of any kind to you.
...
F. Be a Good Partner to Twitter
    ...
    If you provide Twitter Content to third parties, including downloadable datasets of Twitter Content or an API that returns Twitter Content, you will only distribute or allow download of Tweet IDs, Direct Message IDs, and/or User IDs.
        ...
        Any Twitter Content provided to third parties remains subject to this Policy, and those third parties must agree to the Twitter Terms of Service, Privacy Policy, Developer Agreement, and Developer Policy before receiving such downloads.
