...
//
export default class FormEnterCode extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.wireframe}>
        ...
        <View style={styles.wireframe}>
          <Text style={[styles.wireframe]}>Enter Code instructions...</Text>
        </View>

        <View style={styles.wireframe}>
          <TextInput style={[styles.wireframe]} placeholder={'### ###'} />
        </View>
